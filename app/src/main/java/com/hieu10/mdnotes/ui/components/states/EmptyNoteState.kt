...
fun EmptyNoteState(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.note_empty_state_title),
                style = MaterialTheme.typography.headlineSmall,
                color = markdownColors.textSecondary
            )
            Text(
                text = stringResource(id = R.string.note_empty_state_description),
            ...
            Button(onClick = onCreateClick) {
                ...
                Text(text = stringResource(id = R.string.btn_create_note))
            }
        }
    }
}
