...
import com.hieu10.mdnotes.sample.states.notesByTagState
...
import com.hieu10.mdnotes.ui.components.states.EmptyNotesWithTagState
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Column {
                        Text(text = stringResource(id = R.string.app_bar_notes_by_tag, state.tagName))
                        Text(
