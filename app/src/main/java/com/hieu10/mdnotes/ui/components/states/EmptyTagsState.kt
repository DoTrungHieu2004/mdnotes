...
fun EmptyTagsState(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.tag_empty_state_title),
                style = MaterialTheme.typography.headlineSmall,
                color = LocalMarkdownColors.current.textSecondary
            )
            Text(
                text = stringResource(id = R.string.tag_empty_state_description),
            ...
            Button(onClick = onCreateClick) {
                ...
                Text(text = stringResource(id = R.string.btn_create_tag))
            }
        }
    }
}
